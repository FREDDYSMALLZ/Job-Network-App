...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Current Jobs applied</div>
   ...
   @endif
                    ...
                    <td><i aria-hidden="true" class="fa fa-map-marker"></i>&nbsp;Address:{{$job->address}}</td>
                    <td><i aria-hidden="true" class="fa fa-globe"></i>&nbsp;Date:{{$job->created_at->diffForHumans()}}</td>
                    <td>
